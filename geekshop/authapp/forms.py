...
class UserLoginForm(AuthenticationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].widget.attrs['placeholder'] = _('Введите имя пользователя')
...
class UserRegisterForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].widget.attrs['placeholder'] = _('Введите имя пользователя')
        self.fields['email'].widget.attrs['placeholder'] = _('Введите адрес эл.почты')
        self.fields['first_name'].widget.attrs['placeholder'] = _('Введите  имя')
        self.fields['last_name'].widget.attrs['placeholder'] = _('Введите  фамилию')
